...
const TheaterCard = (props: TheaterCardProps) => {
  ...
  return (
  <div className="flex items-center justify-between rounded-xl border border-gray-700 px-6 py-5 transition hover:border-[#1090DF] hover:bg-white/5 hover:scale-[1.03] hover:cursor-pointer" onClick={()=>openTheatre(id)}>
      <div>
